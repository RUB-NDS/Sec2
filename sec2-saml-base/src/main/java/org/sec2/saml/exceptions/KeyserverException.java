 ...
 * December 02, 2012
 */
public class KeyserverException extends SAMLEngineException {

    /**
     * A prefix that is logged before each message.
     */
    private static final String PREFIX = "Keyserver error";

    /**
     * By default, KeyserverExceptions are an error.
     */
    private static final SeverityLevel DEFAULT_SEVERITY = SeverityLevel.ERROR;

    /**
     * Constructs an instance of <code>KeyserverException</code>
     * with the specified detail message.
     * @param msg the detail message.
     */
    public KeyserverException(final String msg) {
     ...
     */
    public KeyserverException(final Throwable cause) {
     ...
     * @param cause the cause of this exception.
     */
    public KeyserverException(final String msg, final Throwable cause) {
     ...
     */
    public KeyserverException(final String pMessage, final Throwable pCause,
     ...
     * @param pMarker the marker of the log message
     */
    protected KeyserverException(final String pPrefix, final String pMessage,
