...
/**
 * An interface for an XML element containing a list of users.
 *
...
public interface UserList extends UserListType, Sec2ResponseMessage {
    /** Local name of the UserList element. */
    String DEFAULT_ELEMENT_LOCAL_NAME = "userList";
