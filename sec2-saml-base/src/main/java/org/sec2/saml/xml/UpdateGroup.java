...
/**
 * An XML message to update a group.
 *
...
public interface UpdateGroup extends GroupRequestType, Sec2RequestMessage {
    /** Local name of the UpdateGroup element. */
    String DEFAULT_ELEMENT_LOCAL_NAME = "updateGroup";
