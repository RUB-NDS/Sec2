...
/**
 * An XML message that contains the keyserver's information about a group.
 *
...
public interface GroupInfo extends GroupResponseType, Sec2ResponseMessage {
    /** Local name of the GroupInfo element. */
    String DEFAULT_ELEMENT_LOCAL_NAME = "groupInfo";
