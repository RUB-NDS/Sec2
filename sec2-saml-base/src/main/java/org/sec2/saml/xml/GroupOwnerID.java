...
/**
 * An interface for an XML element containing a group's owner's ID.
 *
...
public interface GroupOwnerID extends XSBase64Binary {
    /** Local name of the GroupOwner element. */
    String DEFAULT_ELEMENT_LOCAL_NAME = "groupOwnerID";
