...
/**
 * An XML message to get the members of a group.
 *
...
public interface GetGroupMembers extends XSString, Sec2RequestMessage {
    /** Local name of the GetGroupMembers element. */
    String DEFAULT_ELEMENT_LOCAL_NAME = "getGroupMembers";
