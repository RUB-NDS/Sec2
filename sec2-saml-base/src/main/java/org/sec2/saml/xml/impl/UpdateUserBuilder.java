...
/**
 * Builder for {@link org.sec2.saml.xml.UpdateUser} objects.
 *
...
public class UpdateUserBuilder
                    extends AbstractXMLObjectBuilder<UpdateUser> {
    /** {@inheritDoc} */
    @Override
    public UpdateUser buildObject(final String namespaceURI,
            final String localName, final String namespacePrefix) {
        return new UpdateUserImpl(
