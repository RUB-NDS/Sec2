...
/**
 * An interface for an XML element containing a group's name.
 *
...
public interface GroupName extends XSString {
    /** Local name of the GroupName element. */
    String DEFAULT_ELEMENT_LOCAL_NAME = "groupName";
