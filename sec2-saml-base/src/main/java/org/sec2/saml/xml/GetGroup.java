...
public interface GetGroup extends XSString, Sec2RequestMessage {
    /** Local name of the GetGroup element. */
    String DEFAULT_ELEMENT_LOCAL_NAME = "getGroup";
