...
/**
 * An XML message to get all groups where a user is member.
 *
...
public interface GetGroupsForUser extends XSBase64Binary, Sec2RequestMessage {
    /** Local name of the GetGroupsForUser element. */
    String DEFAULT_ELEMENT_LOCAL_NAME = "getGroupsForUser";
