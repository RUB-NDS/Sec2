...
/**
 * An interface for an XML request message containing information about a group.
 *
...
public interface GroupRequestType extends GroupBaseType {
    /** Local name of the XSI type. */
    String TYPE_LOCAL_NAME = "groupRequestType";
