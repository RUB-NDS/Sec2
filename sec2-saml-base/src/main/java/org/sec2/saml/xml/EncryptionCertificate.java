...
/**
 * An interface for an XML element containing a encryption certificate.
 *
...
public interface EncryptionCertificate extends XSBase64Binary {
    /** Local name of the EncryptionCertificate element. */
    String DEFAULT_ELEMENT_LOCAL_NAME = "encryptionCertificate";
