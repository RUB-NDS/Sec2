...
/**
 * Tests for the AddUsersToGroup element.
 *
 ...
 * May 18, 2013
 */
public final class AddUsersToGroupTests
                    extends AbstractXMLElementTests<AddUsersToGroup> {
    /** {@inheritDoc }. */
    @Override
    ...
    /** {@inheritDoc }. */
    @Override
    protected AddUsersToGroup getElementForUnmarshalling() {
        AddUsersToGroup xml = this.getBuilder().
