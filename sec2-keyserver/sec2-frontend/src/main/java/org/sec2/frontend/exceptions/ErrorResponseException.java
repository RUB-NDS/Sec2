...
/**
 * An exception telling that the keyserver even failed to create an error
 * response. (A good sign that something *really* bad has happened)
 *
 ...
 * December 07, 2012
 */
public class ErrorResponseException extends AbstractKeyserverException {

    /**
     * A prefix that is logged before each message.
     */
    private static final String PREFIX = "Error response failed";

    /**
     * By default, ErrorResponseExceptions are an error.
     */
    private static final SeverityLevel DEFAULT_SEVERITY = SeverityLevel.ERROR;

    /**
     * Constructs an instance of <code>ErrorResponseException</code>
     * with the specified detail message.
     * @param msg the detail message.
     */
    public ErrorResponseException(final String msg) {
     ...
     * @param cause the cause of this exception.
     */
    public ErrorResponseException(final String msg, final Exception cause) {
     ...
     */
    public ErrorResponseException(final String pMessage, final Throwable pCause,
     ...
     * @param pMarker the marker of the log message
     */
    protected ErrorResponseException(final String pPrefix,
