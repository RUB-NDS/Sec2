...
/**
 * A processor for GetUserInfoByMail requests.
 *
 ...
 * July 24, 2013
 */
class GetUserInfoByMailProcessor extends
        AbstractUserInfoRespondingProcessor<GetUserInfoByMail> {

    /**
     * {@inheritDoc}
     */
    @Override
    public final UserInfo process(
            final GetUserInfoByMail sec2message,
