...
/**
 * An exception telling that the keyserver failed to process input xml.
 *
 ...
 * December 07, 2012
 */
public class XMLProcessException extends AbstractKeyserverException {

    /**
     * A prefix that is logged before each message.
     */
    private static final String PREFIX = "XML Processing failed";

    /**
     * By default, XMLProcessExceptions are an error.
     */
    private static final SeverityLevel DEFAULT_SEVERITY = SeverityLevel.ERROR;

    /**
     * Constructs an instance of <code>XMLProcessException</code>
     * with the specified detail message.
     * @param msg the detail message.
     */
    public XMLProcessException(final String msg) {
     ...
     */
    public XMLProcessException(final Throwable cause) {
     ...
     * @param cause the cause of this exception.
     */
    public XMLProcessException(final String msg, final Exception cause) {
     ...
     */
    public XMLProcessException(final String pMessage, final Throwable pCause,
     ...
     * @param pMarker the marker of the log message
     */
    protected XMLProcessException(final String pPrefix, final String pMessage,
