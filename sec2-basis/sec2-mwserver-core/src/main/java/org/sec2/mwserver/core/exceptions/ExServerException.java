...
/**
 * An exception thrown by the the servers during their processing.
 *
 * @author  Juraj Somorovsky - juraj.somorovsky@rub.de
 * @version 1.0
 */
public class ExServerException extends ExAbstractMiddlewareException {
     ...
     *                          logged.
     */
    public ExServerException(final String message,
