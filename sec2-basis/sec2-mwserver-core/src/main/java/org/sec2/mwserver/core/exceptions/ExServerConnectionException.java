...
/**
 * An exception thrown by the servers during their processing.
 *
 * @author  Juraj Somorovsky - juraj.somorovsky@rub.de
 * @version 1.0
 */
public class ExServerConnectionException extends ExAbstractMiddlewareException {

    /**
     * Default message for the exception.
     */
    public static final String DEFAULT_MESSAGE = "Problems during Server"
            + " running.";
     ...
     *                          logged.
     */
    public ExServerConnectionException(final String message,
     ...
     */
    public ExServerConnectionException() {
