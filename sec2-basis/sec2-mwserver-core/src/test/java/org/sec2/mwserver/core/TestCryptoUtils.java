...
import org.sec2.extern.org.apache.commons.codec.binary.Hex;
import org.sec2.mwserver.core.util.ICryptoUtils;

/**
 * This class implements the ICryptoUtils-interface for testing purposes.
 * 
 * @author schuessler
 */
public class TestCryptoUtils implements ICryptoUtils
{
    /* (non-Javadoc)
