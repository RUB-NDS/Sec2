...
/**
 * Tests for the KeyserverConnector when the connection cannot be established.
 *
 ...
 * August 13, 2013
 */
public class KeyserverConnectorErrorConnectTests extends TestCase {
    ...
    public void setUp() {
        try {
            connector = KeyserverConnectorTestFactory.getKeyserverConnector(
                    MagicKey.errorOnConnect.getKey());
    ...
    public void testGetUserByMail() {
        try {
            ...
            assertTrue(e.getMessage().contains(
                    "Simulated error on opening connection"));
        }
    }
