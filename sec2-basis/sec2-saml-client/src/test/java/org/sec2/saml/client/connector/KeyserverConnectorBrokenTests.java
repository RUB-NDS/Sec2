...
/**
 * Tests for the KeyserverConnector when the stream breaks upon reading.
 *
 ...
 * August 13, 2013
 */
public class KeyserverConnectorBrokenTests extends TestCase {
    ...
    public void testGetUserByMail() {
        try {
            ...
            assertTrue(e.getMessage().contains(
                    "Simulated fault on BrokenInputStream read"));
        }
    }
