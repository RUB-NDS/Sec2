...
public class TokenHelper implements ITokenProgress {
    ...
    private static final String DESC_GET_AVAILABLE_CLUSTER_KEYS = "Requesting list of available cluster-key ids";
    ...
    public String[] listClusterKeyIds(ByteArray PIN) throws TokenException {
        ...
        progressCallback.update(DESC_GET_AVAILABLE_CLUSTER_KEYS);
        ClusterKeyId[] keyIds = sec2Token.getAvailableClusterKeys();
