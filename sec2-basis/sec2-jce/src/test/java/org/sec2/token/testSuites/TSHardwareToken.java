 ...
 * @author benedikt
 */
public class TSHardwareToken extends TestCase {

    public TSHardwareToken(String testName) {
        super(testName);
    }

    public static Test suite() {
        System.out.println("\n==== Starting HardwareToken Tests ====");

        TestSuite suite = new TestSuite();

        suite.addTestSuite(ClusterKeyTest.class);
