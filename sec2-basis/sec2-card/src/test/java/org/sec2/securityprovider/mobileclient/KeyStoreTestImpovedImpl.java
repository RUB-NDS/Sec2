 ...
 */
public abstract class KeyStoreTestImpovedImpl extends TestCase {
     ...
     */
    public KeyStoreTestImpovedImpl(Provider testProvider) {
    ...
    public void setUp() {
        ...
        assertNotNull("No test provider set.", this.testProvider);
        assertNotNull("PublicKey not set.", publicKey);
    ...
    private GroupKey genGroupKey() {
        ...
        try {
            ...
            assertNotNull("The public key must not be null.",publicKey);
