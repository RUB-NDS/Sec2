 ...
 * Dec 1, 2011
 */
public class ExTokenLogin extends SecurityProviderException {

    /**
     * Default message for the exception.
     */
    public static final String DEFAULT_MESSAGE = "Token Login failed.";
    /**
     ...
     */
    public ExTokenLogin(final String message,
