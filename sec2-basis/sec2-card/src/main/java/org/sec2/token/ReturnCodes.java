...
public class ReturnCodes {
     ...
     * GroupKey errors
     */
    private final static short SW_GKEY_BASE = SW_BASE + 0x0010;
    public final static short SW_GKEY_NOT_SET = SW_GKEY_BASE + 0;
    public final static short SW_GKEY_WRONG_SIZE = SW_GKEY_BASE + 1;
    public final static short SW_GKEY_WRONG_ID_SIZE = SW_GKEY_BASE + 2;
    public final static short SW_GKEY_SLOT_COUNT_INVALID = SW_GKEY_BASE + 3;
    public final static short SW_GKEY_SLOT_INVALID = SW_GKEY_BASE + 4;
    public final static short SW_GKEY_SLOT_IN_USE = SW_GKEY_BASE + 5;
    public final static short SW_GKEY_SLOT_EMPTY = SW_GKEY_BASE + 6;
    public final static short SW_GKEY_DATA_INVALID = SW_GKEY_BASE + 7;
