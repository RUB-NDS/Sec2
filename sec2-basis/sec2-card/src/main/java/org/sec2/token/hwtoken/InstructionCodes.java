...
public class InstructionCodes {
     ...
     * GroupKey commands.
     */
    private static final byte INS_GKEY_BASE = 0x40;
    public static final byte INS_GKEY_FIND = INS_GKEY_BASE + 0;
    public static final byte INS_GKEY_GET_FREE_SLOT = INS_GKEY_BASE + 1;
    public static final byte INS_GKEY_SET_ID = INS_GKEY_BASE + 2;
    public static final byte INS_GKEY_SET_KEY = INS_GKEY_BASE + 3;
    public static final byte INS_GKEY_REMOVE = INS_GKEY_BASE + 4;
    public static final byte INS_GKEY_CLEAR_ALL = INS_GKEY_BASE + 5;
    public static final byte INS_GKEY_ENCRYPT = INS_GKEY_BASE + 6;
    public static final byte INS_GKEY_DECRYPT = INS_GKEY_BASE + 7;
    public static final byte INS_GKEY_GET_IDS = INS_GKEY_BASE + 8;
