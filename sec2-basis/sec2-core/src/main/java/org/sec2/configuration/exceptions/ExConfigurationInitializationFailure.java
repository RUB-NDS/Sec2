...
/**
 * Exception for problems during initialization of the configuration.
 *
 * @author Christopher Meyer - christopher.meyer@rub.de
 * @version 0.1 10.06.2013
 */
public class ExConfigurationInitializationFailure extends AConfigurationException {

    /**
     * Default message for the exception.
     */
    public static final String DEFAULT_MESSAGE = "Configuration could not be "
            + "loaded.";
    /**
     ...
     */
    public ExConfigurationInitializationFailure(final String message,
     ...
     */
    public ExConfigurationInitializationFailure() {
