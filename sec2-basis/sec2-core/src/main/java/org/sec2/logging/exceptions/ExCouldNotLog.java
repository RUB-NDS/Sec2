...
/**
 * Exception for problems during logging attempt.
 * @author  Christopher Meyer - christopher.meyer@rub.de
 * @version 0.1
 * 04.01.2011
 */
public class ExCouldNotLog extends ALoggingException {
    /**
     * Default message for the exception.
     */
    public static final String DEFAULT_MESSAGE = "Logging failed.";
     ...
     *                          logged.
     */
    public ExCouldNotLog(final String message,
