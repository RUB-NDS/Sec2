...
/**
 * Exception for problems during opening a log channel.
 * @author  Christopher Meyer - christopher.meyer@rub.de
 * @version 0.1
 * 04.01.2011
 */
public class ExCouldNotOpenLog extends ALoggingException {
    /**
     * Default message for the exception.
     */
    public static final String DEFAULT_MESSAGE = "Could not open log channel.";
     ...
     *                          logged.
     */
    public ExCouldNotOpenLog(final String message,
