 ...
 * 7.4.2011
 */
public abstract class ExAbstractMiddlewareException extends ACommonException {
     ...
     *                          logged.
     */
    public ExAbstractMiddlewareException(final String message,
...
//        }
     ...
     */
    public ExAbstractMiddlewareException() {
