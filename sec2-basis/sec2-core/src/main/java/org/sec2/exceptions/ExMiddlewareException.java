...
/**
 * A default Middleware Exception
 * @author  Juraj Somorovsky - juraj.somorovsky@rub.de
 * @version 0.1
 *
 * 7.4.2011
 */
public class ExMiddlewareException extends ExAbstractMiddlewareException {
     ...
     *                          logged.
     */
    public ExMiddlewareException(final String message,
