...
public final class CRC8 {
    ...
    public static byte update(byte data, byte crc) {
        return CRC8_TABLE[((byte) crc ^ data) & 0xff];
    }
     ...
     * @return The updated CRC value
     */
    public static byte updateBlock(byte[] data, short off, short len, byte crc) {
        for (short i = 0; i < len; i++) {
            crc = CRC8_TABLE[((byte) crc ^ data[(short)(i + off)]) & 0xff];
        }
        return crc;
    }
     ...
     */
    public static byte calc(byte[] data, short off, short len) {
        byte crc = 0;
