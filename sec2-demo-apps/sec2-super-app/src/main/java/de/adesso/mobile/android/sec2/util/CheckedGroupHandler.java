...
/**
 * Works like it super class, but adds an additional array to mark, if a group is checked or not.
 * 
 * @author nike
 *
 */
public class CheckedGroupHandler extends GroupHandler {
    ...
    /**
     * This constructor constructs an object of type CheckedGroupHandler for an empty array of type Group.
     */
    ...
    /**
     * The constructor for the CheckedGroupHandler. It splits up the passed array of type Group in three
     * arrays. One for all the containing IDs, one for all the containing names and one for the information,
     * if a group is checked or net.
     * 
    ...
    /**
     * Returns a copy of the array, where it is marked, whether a group is checked or not
     * 
     * @return A copy of the array where it is marked, whether a group is checked or not
     */
