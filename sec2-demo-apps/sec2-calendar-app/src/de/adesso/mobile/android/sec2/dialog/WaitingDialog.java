...
public class WaitingDialog extends Dialog {
    ...
    private static final Class<?> c = WaitingDialog.class;
    ...
    public void onCreate(final Bundle savedInstanceState) {
        ...
        //        setContentView(R.layout.waitingdialog2);
        //        initAnimations2();
    ...
    public String getMessage() {
        if (tvMessage != null) return tvMessage.getText().toString();
        else return tvMessageBackup;
    ...
    public boolean onKeyDown(final int keyCode, final KeyEvent event) {
        ...
        if (keyCode == KeyEvent.KEYCODE_SEARCH) // we handled this event
        return true;
