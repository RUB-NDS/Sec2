...
/**
 * Container class for all properties required for an HTTP GET request to the cloud.
 * @author schuessler
 *
 */
public final class GetRequestProperties extends RequestProperties
{
    /**
     ...
     */
    public GetRequestProperties(final String host, final String resource, final int port)
    {
