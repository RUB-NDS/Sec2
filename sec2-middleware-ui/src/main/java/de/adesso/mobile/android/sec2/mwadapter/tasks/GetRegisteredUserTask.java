...
/**
 * Calls the method MwAdapter.getRegisteredUser().
 * 
 * @author schuessler
 */
public final class GetRegisteredUserTask extends MwAdapterTask<User>
{
    ...
    public GetRegisteredUserTask(final String key,
    ...
    protected User doInBackground(final Void... params)
    {
        ...
        try
        {
            user = mwAdapter.getRegisteredUser(key, algorithm, appName,
                    port);
        }
